...
<body>
  ...
  <div class="container-fluid ">
	...
	<table class="table table-hover table-responsive">
		...
		<?php
			require("../koneksi.php");
			$sql = "SELECT * FROM tableuser WHERE Level='user'";
			...
			if ($result->num_rows > 0) {
			    while($row = $result->fetch_assoc()) {
			        echo "<tr>";
						...
						echo "<td> 
								<a href='DeletePengguna.php?idUser=$row[idUser]'><button type='button' class='btn btn-danger'>Delete</button></a>
							</td>";
						$count = $count + 1;
					echo "</tr>";
			    }
